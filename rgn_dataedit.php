...
<tr><td><b><font color="white" face="arial" >ID</td><td colspan=2><input name="id" id="id" type="text" value='<?php echo $id;?>'/></td></tr>
...
<tr><td><b><font color="white" face="arial" >Registration Number</td><td colspan=2 ><input  name="reg_no" id="name" type="text" value='<?php echo $reg_no;?>'/></td></tr>

<tr><td><b><font color="white" face="arial" >Nature_Of_Complaint</td><td colspan=2><input name="noc" id="noc" type="text" value='<?php echo $noc;?>'/></td></tr>
<tr>
   <td><b><font color="white" face="arial">Gist of Complaint</td><td colspan="2"><textarea name="gist" cols="80"><?=$gist?>' </textarea></td>
</tr>
